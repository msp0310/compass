...
export function MemberAccountTable({
  ...
  return (
    <section className="user-account-section member-roster-account-section" aria-label="メンバー一覧・ログイン">
      ...
      <tr className={rowClassName}>
        <td>
          <div className="user-member-cell member-master-cell">
            <span style={{ "--avatar-color": member.color } as CSSProperties}>{member.initials}</span>
            <div>
              <input
            ...
            <div className="member-detail-panel">
              <div className="member-detail-basic">
                ...
                <div className="member-detail-actions">
                  <RolePill role={role} />
                  <LoginPill enabled={enabled} missing={!hasEmailAddress({ ...member, loginEmail: email })} />
                  <PasswordSummary accountExists={accountExists} temporaryPassword={temporaryPassword} />
                  <button
...
function PasswordSummary({
  ...
  return <span className="user-password-summary">{accountExists ? "仮PW発行可" : "設定時に発行"}</span>;
}

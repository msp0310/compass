...
export function MasterSettingsPage({
  ...
  const membersWithAccountSettings = useMemo(() => {
    ...
    return members.map((member) => mergeMemberAccountFields(member, accountMembersById.get(member.id)));
  ...
  async function saveMemberAccount(memberId: string, input: SaveMemberAccountInput, rowKey: string) {
              ...
              <div className="team-master-layout">
                    ...
                    {teams.map((item) => {
                      ...
                      return (
                        <button
                          ...
                          className={
                            item.id === selectedTeam.id ? "team-master-row active" : "team-master-row"
                          }
                          key={item.id}
                ...
                <section className="settings-card team-edit-card">
                  ...
                  <div className="settings-fields">
                    <label>
                      チーム名
                      <input onChange={(event) => setTeamName(event.target.value)} value={teamName} />
                    </label>

...
export function ProjectSettingsPage({
  ...
  const [lifecycleStatus, setLifecycleStatus] =
    useState<ProjectLifecycleStatus>(getProjectLifecycleStatus(project));
  ...
  function saveProject() {
    ...
    const availableMemberIds = new Set(
      selectedProjectTeam?.memberIds ?? team.memberIds,
    );
    onSaveProject({
      ...project,
      lifecycleStatus,
      memberIds: projectMemberIds.filter((memberId) =>
